package software.day03.app;

import java.io.File;
import java.io.IOException;
import java.util.List;

import software.day03.io.BankDeserializer;
import software.day03.io.BankLoader;
import software.day03.io.TextBankDeserializer;
import software.day03.io.TextFileBankLoader;
import software.day03.models.Bank;
import software.day03.models.JoltageCalculator;

public class Main {
    public static void main(String[] args) throws IOException {
        BankDeserializer deserializer = new TextBankDeserializer();
        File file = new File("src/test/java/day03/BankTest.txt");
